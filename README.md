...
| `get_server_info` | Report the server version, connector mode and transport, and the REMnux distro version on the target (best-effort; `null` when the target cannot report it) |
